...
# Diz quanto tempo a história deve ser.
# Alterar essa variável tem efeitos em TODOS os módulos
history_length = 1
# Número de primeiros estados de cada episódio que devem ser ignorados
# do conjunto de dados de especialistas:
dead_start = 50
# Conjunto de ações permitidas:
actions = np.array([
    [ 0.0, 0.0, 0.0],  # DIRETO
    [ 0.0, 1.0, 0.0],  # ACELERAR
    [ 1.0, 0.0, 0.0],  # CERTO
    [ 1.0, 0.0, 0.4],  # CERTO_FREIO
    [ 0.0, 0.0, 0.4],  # FREIO
    [-1.0, 0.0, 0.4],  # ESQUERDA_FREIO
